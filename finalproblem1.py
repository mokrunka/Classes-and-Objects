...
def to_dictionaries(list_of_nations):
    result_dict = {}
    dict_headers = ['long_name', 'iso_code', 'iso_short', 'iso_long', 'capital']
    for nation in list_of_nations:
        iso_dict = {}
        iso_dict[dict_headers[0]] = nation.long_name
        iso_dict[dict_headers[1]] = nation.iso_code
        iso_dict[dict_headers[2]] = nation.iso_short
        iso_dict[dict_headers[3]] = nation.iso_long
        iso_dict[dict_headers[4]] = nation.capital
        result_dict[nation.short_name] = iso_dict
    return result_dict
